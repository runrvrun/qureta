...
@endif
                   ...
                   <form method="GET" action="{{route('admin/workshops/cek_id', ['name' => $request->name])}}">
                    ...
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-2">
                          <input type="submit" class="btn btn-primary" name="cek_id" value="CEK ID">
                        </div>
                    ...
                    {!! Form::open(['url' => 'admin/workshops/daftar-workshop', 'class' => 'form-horizontal', 'files' => true]) !!}
                    {!! Form::hidden('user_id', Auth::user()->id) !!}
                      <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                        {!! Form::label('id', 'ID User', ['class' => 'col-md-4 control-label']) !!}
                        <div class="col-md-6">
                            {!! Form::text('id', null, ['class' => 'form-control', 'required' => 'required', 'readonly' => 'readonly']) !!}
                            {!! $errors->first('name', '<p class="help-block">:message</p>') !!}
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-4">
                            <input type="submit" class="btn btn-primary" name="daftar" value="Daftar Workshop">
                        </div>
                    </div>
                    {!! Form::close() !!}
