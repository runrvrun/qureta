                                          ...
                                          <tr>
                                             ...
                                             <td width="174" height="60" align="left">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{ URL::asset('/images/qureta-baru.png') }}" alt="" border="0" height="31" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>                                          <!-- Spacing -->
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                <p>Selamat! Tulisan anda "<strong>{{ $data['title'] }}</strong>" telah terbit di Qureta.com</p>
                                                <p>&nbsp;</p>
                                                <table width="120" height="32" bgcolor="#0275d8" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:normal;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                            <a style="text-decoration: none;color: #fff; text-align:center;" href="{{url('/post/' . $data['slug'] )}}">Lihat Tulisan</a>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                 ...
                                 <td>
                                    <table align="left" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             <td width="20"></td>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #dedede; text-align:left; line-height: 24px;">
                                                &copy; {{date("Y")}} <a href="http://www.qureta.com">Qureta</a>. All rights reserved.
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
