    ...
    <div class="row">
	    ...
	    ?>
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($post->post_status === 'draft' || $post->post_status === 'pending')
                              <?php $param = ['name' => 'savepending', 'class' => 'btn btn-info pull-right marginleftright']; ?>
                              @if($post->word_count < 600)
                                <?php $param = ['name' => 'savepending', 'class' => 'btn btn-info pull-right marginleftright', 'disabled' =>'disabled']; ?>
                              @endif
                              {!! Form::submit('Kirim ke Editor', $param)!!}
                            @endif
                    ...
                    <div class="row pull-right">
                        @if($post->word_count < 600)
                          <small style="color:#ff3333">Tulisan masih kurang dari 700 kata</small><br/>
                        @endif
