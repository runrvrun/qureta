...
//    });
    ...
    Route::get('/post/markpaymentdone/{a}', 'PostsController@markpaymentdone');
    Route::get('/post/markpaymentundone/{a}', 'PostsController@markpaymentundone');
    ...
    Route::get('/buqus', 'Admin\\BuqusController@index');
...
Route::get('/profile/{a}/following', 'ProfileController@following');
Route::get('/profile/{a}/follower', 'ProfileController@follower');
...
//Route yang baru gua buat
// Route::get('/about_us', 'Buqu_postsController@about_us');
...
//minisites
Route::get('/ceritakertas', 'MinisitesController@ceritakertas');
